...
/**
 * Library from StackOverflow:
 * https://stackoverflow.com/a/27384068/5623874
 */
class Autocomplete {
  ...
  static <T> void addAutoComplete(ComboBox<T> comboBox, Comparator<T> comparatorMethod) {
  ...
  static <T> T getText(ComboBox<T> comboBox) {
    if (comboBox.getSelectionModel().getSelectedIndex() < 0) {
      return null;
    } else {
